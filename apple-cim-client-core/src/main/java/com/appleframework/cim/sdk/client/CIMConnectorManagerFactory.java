...
public class CIMConnectorManagerFactory {
	...
	protected static final Logger logger = Logger.getLogger(CIMConnectorManagerFactory.class);
	
	public static String connectorManagerClazz = "com.appleframework.cim.sdk.client.CIMConnectorManagerImpl";
