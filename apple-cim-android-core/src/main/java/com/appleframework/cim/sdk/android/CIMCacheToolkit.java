...
class CIMCacheToolkit extends SQLiteOpenHelper {
	...
	private static final String TABLE_SQL = "CREATE TABLE IF NOT EXISTS " + TABLE_NAME
	...
	public synchronized void putString(String key, String value) {
		...
		int result = getSQLiteDatabase().updateWithOnConflict(TABLE_NAME, values, "KEY=?", new String[] { key },
