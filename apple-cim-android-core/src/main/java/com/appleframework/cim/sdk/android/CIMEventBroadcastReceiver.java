...
public abstract class CIMEventBroadcastReceiver extends BroadcastReceiver {
	...
	private void onInnerMessageReceived(com.appleframework.cim.sdk.android.model.Message message, Intent intent) {
	...
	private boolean isForceOfflineMessage(String action) {
		return CIMConstant.MessageAction.ACTION_999.equals(action)
				|| CIMConstant.MessageAction.ACTION_444.equals(action);
	}
	...
	public abstract void onMessageReceived(com.appleframework.cim.sdk.android.model.Message message, Intent intent);
